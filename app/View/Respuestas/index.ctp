<div class="respuestas index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('es_cierta'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($respuesta['Pregunta']['nombre'], array('controller' => 'preguntas', 'action' => 'view', $respuesta['Pregunta']['id'])); ?>
		</td>
		<td><?php echo h($respuesta['Respuesta']['valor']); ?>&nbsp;</td>
		<td><?php echo h($respuesta['Respuesta']['es_cierta']); ?>&nbsp;</td>
		<td class="actions">
